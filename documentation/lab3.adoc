...
This will trigger an automation (based in [this playbooks]) that will connect to the Win10 and execute some tasks:
...
ifdef::env-github[]
image:https://static.thenounproject.com/png/196806-200.png[link=https://youtu.be/QHhklwwOoHQ]
endif::[]

This is the first part of the video where we executed the workflow template. We edited the video and splitted in two in order to avoid minutes waiting the installation of the package that adds no value to the lab neither the demo.

* Part 2

ifdef::env-github[]
image:https://static.thenounproject.com/png/196806-200.png[link=https://youtu.be/2XxwvyfEbX4]
endif::[]
